  ...
  return (
    <div className="max-w-3xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8">
      ...
      <p className="mt-4 max-w-2xl text-md text-gray-500 mb-10">
        We use Google Analytics, a web analysis service of Google Inc. ("Google"), to understand our audience and improve the user experience on our website. Google Analytics uses cookies to help us analyze how users interact with and use the Site, compile reports on the Site’s activity, and provide other services related to Site activity and usage.
        The information generated by the cookie about your use of the Site may be transmitted to and stored by Google on servers in the United States. Google may also transfer this information to third parties where required to do so by law, or where such third parties process the information on Google's behalf.
