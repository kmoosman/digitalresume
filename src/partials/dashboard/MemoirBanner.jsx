        ...
        <div className="h-full md:align-left w-full col-span-5 lg:col-span-5 p-5 lg:px-20">
          <div className="grid grid-cols-5">
            <div className="col-span-4">
              <h1 className="text-4xl md:text-5xl mt-10 font-bold lg:mt-10 text-slate-700 animate-fade-in-down">
              ...
              <p className="italic mt-2 text-sm text-slate-700 animate-fade-in">
            ...
            <div className="z-0 mr-0 justify-center col-span-1 bg-yellow-100 opacity-95 lg:hidden">
              <img
